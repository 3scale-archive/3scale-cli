...
exports.createService = function(name, backend_version){
    ...
    if (backend_version)
      options.form["backend_version"] = backend_version
...
exports.updateService = function(service_id, name, backend_version){
  var url = config.API+"/services/"+service_id+".json";
  var options ={
    method:'PUT',
    url: url,
