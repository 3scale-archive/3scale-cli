...
var HIT_METRIC_ID ="";
exports.import = function(path,service_id, appplan_name){
  parrser.parse(path, function(err,api){
    ...
    if(api){ //swagger valid file
      ...
      if(service_id){ //update existing service
        ...
        threescale_waterfall(api, service_id,appplan_name);
      }else{
...
var  threescale_waterfall= function(api, service_id, appplan_name){
