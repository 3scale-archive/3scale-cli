...
exports.createMappingRule= function(service_id, http_method, pattern, delta, metric_id){
  ...
  return response.then(function (r) {
    ...
    if (res.statusCode >= 300) {
      ...
      var msg = "Mapping rule for method "+http_method.toString().inverse+" on path "+pattern.toString().inverse+" created."
      cli.print({message:msg, type:"success", data:body.mapping_rule});
...
exports.updateMappingRule= function(service_id, mapping_rule_id, http_method, pattern, delta, metric_id){
  ...
  return response.then(function (r) {
    ...
    if (res.statusCode >= 300) {
      ...
      var msg = "Mapping rule id "+mapping_rule_id.inverse+" updated."
      cli.print({message:msg, type:"success", data:body.mapping_rule});
      return body.mapping_rule;
    }
  });
...
exports.listMappingRules= function(service_id){
  ...
  return response.then(function (r) {
    ...
    if (res.statusCode >= 300) {
      ...
      var msg = "There are "+body.mapping_rules.length+" mapping rules for this service."
      cli.print({message:msg, type:"success", data:body.mapping_rules});
...
exports.deleteMappingRule= function(service_id, mapping_rule_id){
  ...
  return response.then(function (r) {
    if (r[0].statusCode >= 300) {
      ...
      var msg = "Mapping rule id "+mapping_rule_id.inverse+" has been deleted."
